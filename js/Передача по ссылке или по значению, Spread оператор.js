...
console.log(newNumbers);                    //выведем результат на экран (увидем что number.a =2, а новый элемент newNumbers.a = 10 тем самым это не ссылка а новый объект с такими же ключами)
console.log(numbers);                       //выведем на экран number (но обратите внимание что С - это объект внутри объекта и при его присвоении объекта в объект создалась ссылка и при изменении подобъекта в новом объекте и в старом тоже значение изменилось т.к. получили ссылку)
...
console.log(add);                           //выведем на экран add (первоначальное значение)
console.log(clone);                         //выведем на экран результат (слияния пустота + add) т.е. получим новый объект а не ссылку на старый
...
function log(a, b, c) {                                         //создаем функцию с названием log (которая переносит в себе 3 аргумента ) выполни ниже
    console.log(a);                                             //вывести на экран значение а
    console.log(b);                                             //вывести на экран значение b
    console.log(c);                                             //вывести на экран значение c
}
